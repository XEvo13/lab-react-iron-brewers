...
function AddBeerPage() {
  ...
  const BeerURL = "https://ih-beers-api2.herokuapp.com/beers/new";
  const listing = "https://ih-beers-api2.herokuapp.com/beers"
  ...
  const handleSubmit = (e) => {
    ...
    const newBeer = {name,tagline,description,imageUrl,
                    firstBrewed,brewersTips,attenuationLevel,contributedBy}

    axios
    .post(`${BeerURL}`,newBeer)
    .then((response) =>{
